...
public class ThrowingKnife extends Item{
	...
	public ThrowingKnife(Properties p_41383_) {
		super(p_41383_);
	...
	public InteractionResultHolder<ItemStack> use(Level p_43142_, Player p_43143_, InteractionHand p_43144_) {
	      ...
	      p_43142_.playSound((Player)null, p_43143_.getX(), p_43143_.getY(), p_43143_.getZ(), SoundEvents.PLAYER_ATTACK_SWEEP, SoundSource.NEUTRAL, 0.5F, 0.4F / (p_43142_.getRandom().nextFloat() * 0.4F + 0.8F));
	      if (!p_43142_.isClientSide) {
	         ThrowingKnifeEntity throwingKnife = new ThrowingKnifeEntity(p_43142_, p_43143_);
	         throwingKnife.setItem(itemstack);
	         throwingKnife.shootFromRotation(p_43143_, p_43143_.getXRot(), p_43143_.getYRot(), 0.0F, 1.5F, 1.0F);
	         p_43142_.addFreshEntity(throwingKnife);
	      }
